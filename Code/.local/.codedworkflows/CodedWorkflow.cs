...
namespace Vois_task
{
    ...
    {
        private Lazy<global::Vois_task.WorkflowRunnerService> _workflowRunnerServiceLazy;
        ...
        public CodedWorkflow()
        {
            ...
            _workflowRunnerServiceLazy = new Lazy<global::Vois_task.WorkflowRunnerService>(() => new global::Vois_task.WorkflowRunnerService(this.services));
#pragma warning disable
            _connectionsManagerLazy = new Lazy<ConnectionsManager>(() => new ConnectionsManager(serviceContainer));
#pragma warning restore
        }

        protected global::Vois_task.WorkflowRunnerService workflows => _workflowRunnerServiceLazy.Value;
